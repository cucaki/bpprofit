...
<head>
    ...
    <title>Profit Kalkulátor - Dinamikus</title>
        ...
        function ProfitKalkulator() {
            ...
            const handleFileUpload = (e) => {
                ...
                reader.onload = (event) => {
                    ...
                    const processedOrders = jsonData.map(row => ({
                        ...
                        itemCost: Number(row['Item Cost']) || 0, // Ez az eladási ár az excelben
                    ...
                    processedOrders.forEach(order => {
                        ...
                        // Kiszámoljuk az egységárat (ha esetleg a Cost a sorösszeg lenne, de általában darabár)
                        // Biztonság kedvéért: ha a mennyiség > 1, akkor is az Item Cost-ot vesszük alapul, 
                        // de feltételezzük, hogy az "Item Cost" oszlop az egységárat vagy a sor összegét jelenti. 
                        // A legbiztosabb, ha a fájlban lévő legnagyobb árat keressük meg az adott termékhez (kedvezmények nélküli ár).
                        
                        // Egységár becslése (ha az Item Cost a sor végösszege):
                        const unitPrice = order.quantity > 0 ? (order.itemCost / order.quantity) : 0;
                        // VAGY ha az Item Cost eleve egységár (WooCommerce exportban gyakran az), akkor:
                        // const unitPrice = order.itemCost; 
                        // A biztonság kedvéért a korábbi logikát követve: 
                        // Ha az Item Cost 5000 és Quantity 1, akkor 5000. 
                        // A kódban lévő minta alapján (Cost 1790, Qty 1) ez egységárnak tűnik.
                        // Használjuk a nyers Item Cost-ot egységárként, de figyeljük a maximumot.
                    ...
                    Object.keys(foundProducts).forEach(name => {
                        if (!newPricesState[name]) {
                            ...
                            // Már ismert termék, frissítjük az eladási árat ha változott (opcionális), 
                            // de a beszerzési árat békén hagyjuk.
                            // Ha a beszerzési ár 0, akkor jelezzük, hogy szerkeszteni kell.
                    ...
                    // Ha van olyan termék, aminek 0 a beszerzési ára, irány a szerkesztő
            ...
            const profitData = useMemo(() => {
                ...
                orders.forEach(order => {
                    ...
                    if (!prices) return; // Ha valamiért nincs ár, kihagyjuk (elvileg ilyen nem lesz)

                    const revenue = prices.eladasi_ar * order.quantity; // A beállított eladási árral számolunk
                    ...
                    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-100">
                        <div className="max-w-xl w-full bg-white rounded-xl shadow-2xl p-8">
                            ...
                            <div className="mt-6 flex justify-between text-sm text-gray-400">
                                <span>v2.0 - Dinamikus árazás</span>
                    ...
                    <div className="min-h-screen bg-gray-50 p-6">
                        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                            ...
                            <div className="p-4 bg-yellow-50 border-b border-yellow-100 text-yellow-800 text-sm">
                                ℹ️ <strong>Tipp:</strong> Az "Eladási ár" automatikusan kitöltve az Excelben talált legmagasabb értékkel. A "Beszerzési árat" kell megadnod. A Tab billentyűvel gyorsan haladhatsz.
                            </div>
                            ...
                            <div className="overflow-x-auto max-h-[70vh] overflow-y-auto">
                                <table className="w-full text-left border-collapse">
                                    <thead className="bg-gray-100 sticky top-0 z-10 shadow-sm">
                                        <tr>
                                            <th className="p-4 border-b font-semibold text-gray-600 w-1/2">Termék neve (Excelből)</th>
